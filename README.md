...
Click Create note, then press and drag to preview any size immediately. Release before 200 ms for a 200 × 200 note; otherwise, release to create the drawn size with a minimum of 100 × 100. Click note text to edit it. Drag the note background to move it, and release over the trash to delete it.
